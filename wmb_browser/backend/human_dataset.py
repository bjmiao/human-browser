...
class HumanDataset(Dataset):
    ...
    def __init__(self, name: str, filename: str) -> None:
        ...
        coords = ['umap', 'tsne']
        for coord in coords:
            self.add_coords(coord, pd.DataFrame(self.dataset_handle.obsm["X_"+coord], index=self.dataset_handle.obs.index))
    ...
    def get_var_values(self, set_name: str, var_name: str) -> pd.Series:
        ...
        elif var_name in _da.var.feature_name: # "DDX11L1"
            _data = _da[:, _da.var.feature_name == var_name]
